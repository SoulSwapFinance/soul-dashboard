                ...
                <div class="col">
                    ...
                    <f-card>
                        <div>
                            ...
                            elit. Dicta eos minima numquam. Accusamus asperiores
                            eaque magni nisi, perspiciatis quam repellat! Ab
                            beatae consectetur cumque dignissimos, fuga
                            provident quod vel? Quos?
                        </div>
                    </f-card>
                </div>
                <div class="col">
...
export default {
    ...
    methods: {
        ...
        onTest() {
            ...
            const tmpPKey =
                '0x0eb5dd4c57efd9a3b813b824a0a7c1387dffe367c7f573867d4fefa801474b22';
            const tmpKeystore = {
                version: 3,
                ...
                crypto: {
                    ciphertext:
                        'ae9ccb22b7eb3fcf4de63a9f573cbfdab9aef2a91b5c4dcb71439fd319fa194e',
                    ...
                    kdfparams: {
                        dklen: 32,
                        salt:
                            '7b7b8f84587652e67a2f14d129f7f4eb7414be2e39369bf5cc397e09a6127596',
                        n: 8192,
                        r: 8,
                        p: 1,
                    },
                    mac:
                        '6206ee875951ace5c8b12334e655990cf9d2628c0c37cd3114ee30836e517767',
                },
            };
            let t1 = 0;
            let t2 = 0;
            ...
            try {
                t1 = performance.now();
                const account = this.$fWallet.restoreAccountByPrivateKey(
                    tmpPKey
                );
            ...
            try {
                t1 = performance.now();
                const keystore = this.$fWallet.encryptToKeystore(
                    tmpPKey,
                    tmpPwd
                );
                t2 = performance.now() - t1;
            ...
            try {
                t1 = performance.now();
                const accountFromKeystore = this.$fWallet.decryptFromKeystore(
                    tmpKeystore,
                    tmpPwd
                );
                t2 = performance.now() - t1;

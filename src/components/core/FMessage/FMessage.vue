    ...
    <div class="f-message" :class="[classes, type]">
        <slot name="prefix">
            <template v-if="withIcon">
                <icon v-if="type === 'success'" data="@/assets/svg/message/check-circle.svg" width="16" height="16" />
                <icon
                    v-if="type === 'error'"
                    ...
                    height="16"
                />
                <icon v-if="type === 'info'" data="@/assets/svg/message/info-circle.svg" width="16" height="16" />
            </template>
        </slot>

 ...
 */
function fLendDeposit(web3, asset, amount, onBehalfOf, referralCode) {
 ...
 * @returns {{data: string, to: *, value: string}}
 */
function fLendWithdraw(web3, asset, amount, to) {
    // create web3 instance if needed
    if (null === web3) {
        web3 = new Web3();
    }
 ...
 * @returns {{data: string, to: *, value: string}}
 */
function fLendBorrow(web3, asset, amount, interestRateMode, referralCode, onBehalfOf) {
    // create web3 instance if needed
    if (null === web3) {
        web3 = new Web3();
    }
 ...
 * @returns {{data: string, to: *, value: string}}
 */
function fLendRepay(web3, asset, amount, rateMode, onBehalfOf) {
    // create web3 instance if needed
    if (null === web3) {
        web3 = new Web3();
    }
 ...
 * @returns {{data: string, to: *, value: string}}
 */
function fLendSwapBorrowRateMode(web3, asset, rateMode) {
    // create web3 instance if needed
    if (null === web3) {
        web3 = new Web3();
    }
 ...
 * @returns {{data: string, to: *, value: string}}
 */
function fLendSetUserUseReserveAsCollateral(web3, asset, useAsCollateral) {
    // create web3 instance if needed
    if (null === web3) {
        web3 = new Web3();
    }
 ...
 * @returns {{data: string, to: *, value: string}}
 */
function fLendFlashLoan(web3, address, assets, amounts, modes, onBehalfOf, params, referralCode) {
    // create web3 instance if needed
    if (null === web3) {
        web3 = new Web3();
    }
 ...
 * @returns {{data: string, to: *, value: string}}
 */
function fLendLiquidationCall(web3, address, debt, user, debtToCover, receiveAToken) {
    // create web3 instance if needed
    if (null === web3) {
        web3 = new Web3();
    }
